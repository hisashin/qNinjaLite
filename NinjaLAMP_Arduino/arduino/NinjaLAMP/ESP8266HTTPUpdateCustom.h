...
#ifndef ESP8266HTTPUPDATECUSTOM_H_
#define ESP8266HTTPUPDATECUSTOM_H_
...
class ESP8266HTTPUpdateCustom
{
public:
    ESP8266HTTPUpdateCustom(void);
    ~ESP8266HTTPUpdateCustom(void);

    void CheckNinjaPCR(void);
...
protected:
    virtual t_httpUpdate_return handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs = false);
    virtual bool runUpdate(Stream& in, uint32_t size, String md5, int command = U_FLASH);

    int _lastError;
    bool _rebootOnUpdate = true;
};

extern ESP8266HTTPUpdateCustom ESPhttpUpdate;

#endif /* ESP8266HTTPUPDATECUSTOM_H_ */
